Attribute VB_Name = "PrinterBas"

Public Const cdlPDAllPages = &H0
...
Public Const cdlPDNoPageNums = &H8
Public Const cdlPDNoSelection = &H4
Public Const cdlPDNoWarning = &H80
Public Const cdlPDPageNums = &H2
...
Public Const cdlPDSelection = &H1
...
Public Function SetPrintPage(PageSize As Integer) As Integer
  On Error GoTo ErrHandlerPrintSize
  
  Printer.PaperSize = PageSize
  Exit Function
